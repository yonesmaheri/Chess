...
const courseSeeds = [
  {
    ...
    description:
      'این دوره پایه‌ای، قوانین، اصول توسعه، کنترل مرکز و ساختار ذهنی لازم برای شروع حرفه‌ای شطرنج را پوشش می‌دهد.',
    thumbnailImage:
  ...
  },
  {
    ...
    description:
      'در این دوره ساختارهای مختلف پیاده‌ای، نقاط ضعف و قوت هر ساختار و چگونگی استخراج پلان از آن‌ها آموزش داده می‌شود.',
    thumbnailImage:
  ...
  },
  {
    ...
    description:
      'یاد می‌گیرید چگونه ریتم بازی را به دست بگیرید، تهدید بسازید و با حفظ فشار، حریف را به دفاع منفعل وادار کنید.',
    thumbnailImage:
  ...
  },
  {
    ...
    description:
      'الگوهای تاکتیکی پرکاربرد، مات‌های کلاسیک و روش‌های محاسبه‌ای لازم برای برنده شدن در موقعیت‌های حساس را یاد می‌گیرید.',
    thumbnailImage:
      'https://images.unsplash.com/photo-1604948501466-4e9c339b9c24?auto=format&fit=crop&w=1200&q=80',
  ...
  },
  {
    ...
    description:
      'این دوره نشان می‌دهد چگونه طرح‌های استراتژیک را به حملات موثر تبدیل کنید و از برتری‌های کوچک، فشار واقعی بسازید.',
    thumbnailImage:
      'https://images.unsplash.com/photo-1543092587-d8b8feaf3628?auto=format&fit=crop&w=1200&q=80',
  ...
  },
  {
    ...
    description:
      'چهار اصل کلیدی استراتژی شامل فضا، ساختار، فعالیت مهره‌ها و امنیت شاه به صورت کاربردی و قابل‌اجرا آموزش داده می‌شوند.',
    thumbnailImage:
...
function buildLeaderboardEntries(mode: LeaderboardMode) {
  ...
  const generatedPlayers = Array.from({ length: 70 }, (_, index) => {
    ...
    const trend = Math.max(
      0.2,
      1.3 - index * 0.015 + (mode === LeaderboardMode.puzzle ? 0.35 : 0),
    );
...
async function main() {
  ...
  const instructorMap = new Map<string, { id: string }>();
  ...
  await prisma.leaderboardEntry.createMany({
    data: [
      ...buildLeaderboardEntries(LeaderboardMode.blitz),
      ...buildLeaderboardEntries(LeaderboardMode.rapid),
      ...buildLeaderboardEntries(LeaderboardMode.puzzle),
    ],
  });
}
